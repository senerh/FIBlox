	...
	echo '
		<table class="tab_cadre_fixe">
			<tbody>
				...
				<tr><td style="text-align: right;" width="50%">IP du serveur</td> <td style="text-align: left;" >'.$tab[0].'</td></tr>
		...
		<form action="'.basename($_SERVER['PHP_SELF']).'" method="post">
			<table class="tab_cadre_fixe">
				<tbody>
					...
					<tr><td style="text-align: right;" width="50%">IP du serveur</td> <td style="text-align: left;" ><input type="text" name="ip"/></td></tr>
